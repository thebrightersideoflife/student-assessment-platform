// src/components/AssessmentIcons.jsx
// All SVG icon components used by AssessmentPage and its sub-components.
...
export const LeftArrowIcon = ({ size = 14 }) => (
...
export const RightArrowIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
