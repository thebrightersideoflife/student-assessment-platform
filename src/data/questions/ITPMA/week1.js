    ...
    correctAnswers: [
      {
        text: 'A project possesses several defining characteristics that influence both planning and execution.\n\n'
          + '**1. Temporary Nature**\n\nThe patient registration project is temporary because it has a defined start and end, ending when the system is implemented and formally accepted. *This influences planning by requiring a defined schedule, milestones, resource commitments and closure activities*. The project manager must ensure that time and resources are controlled so that the system is delivered within the agreed implementation period rather than treating the project as an ongoing operational activity.\n\n'
